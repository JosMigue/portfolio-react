        ...
        <ol className="relative border-l border-gray-200">
          {jobs.map((job, index) => (
            <li className="mb-10 ml-6" key={index}>            
              ...
              <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">{job.title} ({job.modality}) {job.current ? <span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3">Current</span> : ''}</h3>
